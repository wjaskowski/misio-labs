...
public final class BoardUtils {
	...
	public static int toPos(int boardWidth, int row, int col) {
		return toPos(new RectSize(boardWidth), new BoardPos(row, col));
	}
	 ...
	 */
	// TODO: Make it deprecated?
	public static int toPos(RectSize boardSize, int row, int col) {
		return toPos(boardSize, new BoardPos(row, col));
	}

	/**
	 * Returned position is margin-based (not 0-based)
	 */
	public static int toPos(RectSize boardSize, BoardPos pos) {
