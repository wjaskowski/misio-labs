...
public class OthelloWPCMoveDeltaEvalutor implements BoardMoveEvaluator<OthelloBoard> {

	public final static int NUM_WEIGHTS = OthelloBoard.SIZE * OthelloBoard.SIZE;
	 ...
	 */
	public OthelloWPCMoveDeltaEvalutor(WPC wpc) {
